...
- Model chat = `gemini-3.5-flash` (chốt 2026-07-21; đổi từ `gemini-2.5-flash` — bản 2.5 bị Google
  khóa với API key mới, phát hiện khi verify #4a). Embedding — chốt sau cùng RAG.
